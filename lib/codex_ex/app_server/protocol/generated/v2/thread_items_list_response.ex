defmodule CodexEx.AppServer.Protocol.Generated.V2.ThreadItemsListResponse do
  @moduledoc false
  ...
  @field_specs [
    ...
    %{
      spec: {:array, {:module, Module.concat(__MODULE__, "ThreadItemEntry")}},
      field: :data,
      required: true,
      wire_key: "data"
    },
  ...
  defmodule MemoryCitation do
    ...
    alias ThreadItemsListResponse, as: ParentModule
  ...
  defmodule ThreadItemEntry do
    @moduledoc false

    defstruct [:item, :turn_id]
