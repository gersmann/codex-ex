defmodule CodexEx.AppServer.Protocol.Generated.V2.HookCompletedNotification do
  @moduledoc false
  ...
  defmodule HookRunSummary do
    ...
    alias CodexEx.AppServer.Protocol.Generated.V2.HookCompletedNotification, as: ParentModule
