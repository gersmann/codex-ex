defmodule CodexEx.AppServer.Protocol.Generated.V2.ThreadTurnsListResponse do
  @moduledoc false
  ...
  @field_specs [
    ...
    %{
      spec: {:array, {:module, Module.concat(__MODULE__, "Turn")}},
      field: :data,
      required: true,
      wire_key: "data"
    },
  ...
  defmodule MemoryCitation do
    ...
    alias ThreadTurnsListResponse, as: ParentModule
