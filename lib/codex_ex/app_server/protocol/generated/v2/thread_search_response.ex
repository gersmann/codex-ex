defmodule CodexEx.AppServer.Protocol.Generated.V2.ThreadSearchResponse do
  @moduledoc false

  alias CodexEx.AppServer.Protocol.Codec
  alias CodexEx.AppServer.Protocol.Generated.V2.ThreadSearchResponse
  ...
  @field_specs [
    ...
    %{
      spec: {:array, {:module, Module.concat(__MODULE__, "ThreadSearchResult")}},
      field: :data,
      required: true,
      wire_key: "data"
    },
  ...
  defmodule MemoryCitation do
    ...
    alias ThreadSearchResponse, as: ParentModule
  ...
  defmodule ThreadSearchResult do
    @moduledoc false

    alias ThreadSearchResponse, as: ParentModule

    defstruct [:snippet, :thread]

    @field_specs [
      %{spec: :plain, field: :snippet, required: true, wire_key: "snippet"},
      %{
        spec: {:module, Module.concat(ParentModule, "Thread")},
        field: :thread,
        required: true,
        wire_key: "thread"
      }
