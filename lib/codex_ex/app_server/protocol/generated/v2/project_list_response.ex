defmodule CodexEx.AppServer.Protocol.Generated.V2.ProjectListResponse do
  @moduledoc false
  ...
  @field_specs [
    %{
      spec: {:array, {:module, Module.concat(__MODULE__, "Project")}},
      field: :data,
      required: true,
      wire_key: "data"
    },
  ...
  defmodule Project do
    ...
    alias CodexEx.AppServer.Protocol.Generated.V2.ProjectListResponse, as: ParentModule
