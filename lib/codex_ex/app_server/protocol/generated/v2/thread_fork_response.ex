defmodule CodexEx.AppServer.Protocol.Generated.V2.ThreadForkResponse do
  @moduledoc false

  alias CodexEx.AppServer.Protocol.Codec
  alias CodexEx.AppServer.Protocol.Generated.V2.ThreadForkResponse
  ...
  defmodule MemoryCitation do
    ...
    alias ThreadForkResponse, as: ParentModule
