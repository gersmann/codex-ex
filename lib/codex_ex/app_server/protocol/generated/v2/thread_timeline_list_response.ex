defmodule CodexEx.AppServer.Protocol.Generated.V2.ThreadTimelineListResponse do
  @moduledoc false

  alias CodexEx.AppServer.Protocol.Codec
  alias CodexEx.AppServer.Protocol.Generated.V2.ThreadTimelineListResponse

  defstruct [:active_realtime_session_at_page_start, :data, :next_cursor]

  @field_specs [
    %{
      spec: {:nullable, :plain},
      field: :active_realtime_session_at_page_start,
      required: false,
      wire_key: "activeRealtimeSessionAtPageStart"
    },
  ...
  defmodule MemoryCitation do
    ...
    alias ThreadTimelineListResponse, as: ParentModule
