defmodule CodexEx.AppServer.Protocol.Generated.V2.ExternalAgentConfigImportParams do
  @moduledoc false

  alias CodexEx.AppServer.Protocol.Codec
  alias CodexEx.AppServer.Protocol.Generated.V2.ExternalAgentConfigImportParams

  defstruct [:migration_items, :migration_source, :provider_id, :source]

  @field_specs [
    %{
      spec: {:array, {:module, Module.concat(__MODULE__, "ExternalAgentConfigMigrationItem")}},
      field: :migration_items,
      required: true,
      wire_key: "migrationItems"
    },
    %{
      spec: {:nullable, :plain},
  ...
  defmodule ExternalAgentConfigMigrationItem do
    ...
    alias ExternalAgentConfigImportParams,
      as: ParentModule
