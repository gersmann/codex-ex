defmodule CodexEx.AppServer.Protocol.Generated.V2.ThreadQueueUpdateResponse do
  @moduledoc false

  alias CodexEx.AppServer.Protocol.Codec

  defstruct [:queued_submission]

  @field_specs [
    %{
      spec: {:module, Module.concat(__MODULE__, "QueuedSubmission")},
      field: :queued_submission,
      required: true,
      wire_key: "queuedSubmission"
    }
  ]
  ...
  defmodule QueuedSubmission do
    @moduledoc false

    defstruct [:client_user_message_id, :id, :input]
  ...
  defmodule TextElement do
    ...
    alias CodexEx.AppServer.Protocol.Generated.V2.ThreadQueueUpdateResponse, as: ParentModule
