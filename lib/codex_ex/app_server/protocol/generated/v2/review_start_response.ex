defmodule CodexEx.AppServer.Protocol.Generated.V2.ReviewStartResponse do
  @moduledoc false

  alias CodexEx.AppServer.Protocol.Codec
  alias CodexEx.AppServer.Protocol.Generated.V2.ReviewStartResponse

  defstruct [:review_thread_id, :turn]

  @field_specs [
    %{spec: :plain, field: :review_thread_id, required: true, wire_key: "reviewThreadId"},
    %{
  ...
  defmodule MemoryCitation do
    ...
    alias ReviewStartResponse, as: ParentModule
