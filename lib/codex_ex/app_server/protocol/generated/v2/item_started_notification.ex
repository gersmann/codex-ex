defmodule CodexEx.AppServer.Protocol.Generated.V2.ItemStartedNotification do
  @moduledoc false

  alias CodexEx.AppServer.Protocol.Codec
  alias CodexEx.AppServer.Protocol.Generated.V2.ItemStartedNotification

  defstruct [:item, :started_at_ms, :thread_id, :turn_id]
  ...
  defmodule MemoryCitation do
    ...
    alias ItemStartedNotification, as: ParentModule
