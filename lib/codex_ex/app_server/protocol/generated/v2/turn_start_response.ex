defmodule CodexEx.AppServer.Protocol.Generated.V2.TurnStartResponse do
  @moduledoc false

  alias CodexEx.AppServer.Protocol.Codec
  alias CodexEx.AppServer.Protocol.Generated.V2.TurnStartResponse
  ...
  defmodule MemoryCitation do
    ...
    alias TurnStartResponse, as: ParentModule
