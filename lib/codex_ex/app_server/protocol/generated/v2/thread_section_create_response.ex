defmodule CodexEx.AppServer.Protocol.Generated.V2.ThreadSectionCreateResponse do
  @moduledoc false
  ...
  defmodule ThreadSection do
    ...
    alias CodexEx.AppServer.Protocol.Generated.V2.ThreadSectionCreateResponse, as: ParentModule
