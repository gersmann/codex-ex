defmodule CodexEx.AppServer.Protocol.Generated.V2.ThreadStartResponse do
  @moduledoc false

  alias CodexEx.AppServer.Protocol.Codec
  alias CodexEx.AppServer.Protocol.Generated.V2.ThreadStartResponse
  ...
  defmodule MemoryCitation do
    ...
    alias ThreadStartResponse, as: ParentModule
