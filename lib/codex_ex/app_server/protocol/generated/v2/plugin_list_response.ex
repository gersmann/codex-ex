defmodule CodexEx.AppServer.Protocol.Generated.V2.PluginListResponse do
  @moduledoc false

  alias CodexEx.AppServer.Protocol.Codec
  alias CodexEx.AppServer.Protocol.Generated.V2.PluginListResponse

  defstruct [:featured_plugin_ids, :marketplace_load_errors, :marketplaces]

  @field_specs [
    %{
      spec: {:array, :plain},
      field: :featured_plugin_ids,
      required: false,
      wire_key: "featuredPluginIds"
    },
    %{
      spec: {:array, {:module, Module.concat(__MODULE__, "MarketplaceLoadErrorInfo")}},
      field: :marketplace_load_errors,
      required: false,
      wire_key: "marketplaceLoadErrors"
    },
    %{
      spec: {:array, {:module, Module.concat(__MODULE__, "PluginMarketplaceEntry")}},
      field: :marketplaces,
      required: true,
      wire_key: "marketplaces"
    }
  ]
  ...
  defmodule MarketplaceInterface do
    @moduledoc false

    defstruct [:display_name]

    @field_specs [
      %{spec: {:nullable, :plain}, field: :display_name, required: false, wire_key: "displayName"}
    ]
  ...
  defmodule MarketplaceLoadErrorInfo do
    @moduledoc false

    defstruct [:marketplace_path, :message]
  ...
  defmodule PluginMarketplaceEntry do
    @moduledoc false

    alias PluginListResponse, as: ParentModule

    defstruct [:interface, :name, :path, :plugins]

    @field_specs [
      %{
        spec: {:nullable, {:module, Module.concat(ParentModule, "MarketplaceInterface")}},
        field: :interface,
        required: false,
        wire_key: "interface"
      },
      ...
      %{
        spec: {:array, {:module, Module.concat(ParentModule, "PluginSummary")}},
        field: :plugins,
        required: true,
        wire_key: "plugins"
      }
