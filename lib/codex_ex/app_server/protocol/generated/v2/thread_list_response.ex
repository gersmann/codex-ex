defmodule CodexEx.AppServer.Protocol.Generated.V2.ThreadListResponse do
  @moduledoc false
  ...
  @field_specs [
    ...
    %{
      spec: {:array, {:module, Module.concat(__MODULE__, "Thread")}},
      field: :data,
      required: true,
      wire_key: "data"
    },
  ...
  defmodule MemoryCitation do
    ...
    alias ThreadListResponse, as: ParentModule
