defmodule CodexEx.AppServer.Protocol.Generated.V2.ItemGuardianApprovalReviewStartedNotification do
  @moduledoc false

  alias CodexEx.AppServer.Protocol.Codec
  alias CodexEx.AppServer.Protocol.Generated.V2.ItemGuardianApprovalReviewStartedNotification

  defstruct [:action, :review, :review_id, :started_at_ms, :target_item_id, :thread_id, :turn_id]
  ...
  defmodule AdditionalFileSystemPermissions do
    ...
    alias ItemGuardianApprovalReviewStartedNotification,
      as: ParentModule
