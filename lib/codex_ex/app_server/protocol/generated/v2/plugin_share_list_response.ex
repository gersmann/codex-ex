defmodule CodexEx.AppServer.Protocol.Generated.V2.PluginShareListResponse do
  @moduledoc false

  alias CodexEx.AppServer.Protocol.Codec
  alias CodexEx.AppServer.Protocol.Generated.V2.PluginShareListResponse

  defstruct [:data]

  @field_specs [
    %{
      spec: {:array, {:module, Module.concat(__MODULE__, "PluginShareListItem")}},
      field: :data,
      required: true,
      wire_key: "data"
    }
  ...
  defmodule PluginShareContext do
    ...
    alias PluginShareListResponse, as: ParentModule
  ...
  defmodule PluginShareListItem do
    @moduledoc false

    alias PluginShareListResponse, as: ParentModule

    defstruct [:local_plugin_path, :plugin]

    @field_specs [
      %{
        spec: {:nullable, :plain},
        field: :local_plugin_path,
        required: false,
        wire_key: "localPluginPath"
      },
      %{
