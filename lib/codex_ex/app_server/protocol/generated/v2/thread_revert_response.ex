defmodule CodexEx.AppServer.Protocol.Generated.V2.ThreadRevertResponse do
  @moduledoc false

  alias CodexEx.AppServer.Protocol.Codec
  alias CodexEx.AppServer.Protocol.Generated.V2.ThreadRevertResponse

  defstruct [:items_backwards_cursor, :thread, :turns_backwards_cursor]
  ...
  defmodule MemoryCitation do
    ...
    alias ThreadRevertResponse, as: ParentModule
