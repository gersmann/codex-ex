defmodule CodexEx.AppServer.Protocol.Generated.V2.ReasoningTextDeltaNotification do
  @moduledoc false

  alias CodexEx.AppServer.Protocol.Codec

  defstruct [:content_index, :delta, :item_id, :thread_id, :turn_id]

  @field_specs [
    %{spec: :plain, field: :content_index, required: true, wire_key: "contentIndex"},
