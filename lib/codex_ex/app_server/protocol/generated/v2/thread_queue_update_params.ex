defmodule CodexEx.AppServer.Protocol.Generated.V2.ThreadQueueUpdateParams do
  @moduledoc false

  alias CodexEx.AppServer.Protocol.Codec

  defstruct [:input, :queued_submission_id, :thread_id]

  @field_specs [
    %{spec: {:array, :plain}, field: :input, required: true, wire_key: "input"},
    %{spec: :plain, field: :queued_submission_id, required: true, wire_key: "queuedSubmissionId"},
  ...
  defmodule TextElement do
    ...
    alias CodexEx.AppServer.Protocol.Generated.V2.ThreadQueueUpdateParams, as: ParentModule
